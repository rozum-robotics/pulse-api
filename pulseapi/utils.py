...
def tool_info(tcp_position: Position, name: str = "unnamed_tool") -> ToolInfo:
    ...
    rotates the new coordinate system according to the given roll pitch and yaw.
    :type tcp_position: Position
    :param name: any random name of the work tool defined by the user (e.g., \\\"gripper\\\"), defaults to "unnamed_tool".
